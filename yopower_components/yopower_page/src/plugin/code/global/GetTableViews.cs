...
{
    public class GetTableViews : PluginBase
    {
        public GetTableViews() : base(typeof(GetTableViews)) { }
        ...
        protected override void ExecuteDataversePlugin(ILocalPluginContext localContext)
        {
            try
            {
                ...
                // Output Parameters
                localContext.PluginExecutionContext.OutputParameters["views"] = JsonConvert.SerializeObject(business.GetTableViews((string)localContext.PluginExecutionContext.InputParameters["table"]));
            ...
            {
                localContext.PluginExecutionContext.OutputParameters["views"] = "{}";
