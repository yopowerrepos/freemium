...
namespace yopower_papps_grid_extensions.models.types
{
    ...
    public class NoteCellModel
    {
        ...
        [DataMember(Order = 3, Name = "fetchXmlAggregate", IsRequired = true)] public string FetchXmlAggregate { get; set; }
        [DataMember(Order = 4, Name = "fetchXml", IsRequired = true)] public string FetchXml { get; set; }
    }
}
